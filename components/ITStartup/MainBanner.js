                        ...
                        <div className="container">
                            <div className="row h-100 justify-content-center align-items-center">
                                <div className="col-lg-5">
                                    ...
                                    <h1>Une intelligence artificielle pour répondre aux appels d'offre</h1>
                                        <p>Notre intelligence artificielle Mansa Pro peut analyser le cahier des charges, préparer une offre compétitive et réaliste, présenter une présentation visuelle, tester et adapter la proposition en fonction des besoins et critères des clients et marchés, évaluer le retour sur investissement et identifier les risques et élaborer des plans pour les gérer.</p>
