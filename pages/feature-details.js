                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 features-details">
                            <div className="features-details-desc">
                                <h3>la puissance de l'IA pour accroitre votre productivité sur les appels d'offres</h3>
                                ...
                                <ul className="features-details-list">
                                    <li>Recherche rapide et efficace des appels d'offre</li>
                                    <li>Analyse et préparation des offres </li>
                                    <li>Présentation des prestations et compétences</li>
                                    <li>Des services et produits sur mesure</li>
                                    <li>Y Suivi des appels d'offre</li>
                                </ul>
                            </div>
                        </div>
                    </div>
